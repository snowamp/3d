...
class rectangle_tr_hedron(object):
	def get_points(self, length , width, height, u_length):
		...
		face_3.append(np.array([-1 * length/2.0, -1 * width/2.0]))
		face_3.append(np.array([-1 * length/2.0, width/2.0]))
		...
		sticker_4.append(np.array([length/2.0 - diff_1, -1 * total_width/2.0 - u_width/2.0]))
